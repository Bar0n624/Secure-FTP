...
def getSessionKey(forcenew=False) -> bytes:
    ...
    if forcenew or (session_key is None):
...
file_hash = calculateFileDigest('D:\\Python\\Projects\\CN-SEM-4\\eftp\\files\\lotus.jpg')
...
with open('D:\\Python\\Projects\\CN-SEM-4\\eftp\\files\\lotus.enc', 'wb') as f:
    for block in encryptSingleChunk(dk, 'D:\\Python\\Projects\\CN-SEM-4\\eftp\\files\\lotus.jpg'):
        f.write(block)
